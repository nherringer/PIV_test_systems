...
cwd = os.getcwd()
shutil.copy(cwd+"/plumed_template_c45.dat", cwd+"/plumed_parameterized.dat")
...
sed_inplace(plumed_file, 'GRID_MIN=.*', 'GRID_MIN='+grid_mins+' GRID_MAX='+grid_maxes+' GRID_BIN=5000,5000')
subprocess.call(cwd+"/clean.sh")
